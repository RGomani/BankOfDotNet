        ...
        public static IEnumerable<Client> GetClients()
        {
            ...
            return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    RedirectUris = { "http://localhost:3003/signin-oidc" },

                    // If the user logs-out from IS4, we need a post-logout redirect URI
                    PostLogoutRedirectUris = { "http://localhost:3003/signout-callback-oidc" },
                   ...
                   new Client
                {
                    ...
                    // We are setting our MVC client port to 5003 
                    // We are making use of signin-oidc which is for Open-ID connect
                    RedirectUris = { "http://localhost:3004/signin-oidc" },

                    // If the user logs-out from IS4, we need a post-logout redirect URI
                    PostLogoutRedirectUris = { "http://localhost:3004/signout-callback-oidc" },
